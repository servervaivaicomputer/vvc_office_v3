...
/* Express strips the mount path from req.path inside a router. Use the
   original URL so /api/* requests never receive an HTML login redirect. */
const isApiRequest = (req) => req.originalUrl.split('?')[0].startsWith('/api/');
